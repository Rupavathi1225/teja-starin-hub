...
export const MingleRelatedSearchesTab = () => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold">Mingle - Related Searches</h2>

      <Card>
        <CardHeader>
          <CardTitle>{editingId ? "Edit" : "Add"} Related Search</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div>
            <Label>Pre-Landing Page Key</Label>
            <Input
      ...
      <Card>
        <CardHeader>
          <CardTitle>Existing Related Searches</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            {searches?.map((search) => (
              <div key={search.id} className="flex items-center justify-between p-4 border rounded">
                <div>
                  <div className="font-medium">{search.search_text}</div>
